...
public class Mail implements Serializable
  {
    ...
    @JoinColumn(name = "CAMPAIGN_ID", referencedColumnName = "ID_MAILING")
    @ManyToOne(optional = false)
    private MailingCampaign campaignId;
    ...
    public MailingCampaign getCampaignId()
      {
        return campaignId;
      }

    public void setCampaignId(MailingCampaign campaignId)
      {
